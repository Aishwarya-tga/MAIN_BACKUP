...
public class GoaFavorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goa_favorite);
        ...
        try {
            ...
            favoritesCursor = db.query("GOA",
                    new String[]{"_id","NAME"},
                    "FAVORITE = 1",
                    null,null,null,null);

            CursorAdapter favoriteAdapter = new SimpleCursorAdapter(GoaFavorite.this,
        ...
        listFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View v, int position, long id){
                Intent intent = new Intent(GoaFavorite.this,GoaActivity.class);
