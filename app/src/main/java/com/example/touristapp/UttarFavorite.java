...
public class UttarFavorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttar_favorite);
        ...
        try {
            ...
            favoritesCursor = db.query("UTTAR",
                    new String[]{"_id","NAME"},
                    "FAVORITE = 1",
                    null,null,null,null);

            CursorAdapter favoriteAdapter = new SimpleCursorAdapter(UttarFavorite.this,
        ...
        listFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> listView, View v, int position, long id){
                Intent intent = new Intent(UttarFavorite.this,UttarActivity.class);
