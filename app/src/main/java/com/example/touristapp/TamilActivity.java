...
public class TamilActivity extends AppCompatActivity {
    ...
    public void openhello() {
        Intent intent = new Intent(this,TamilMapActivity.class);
    ...
    public void onFavoriteClicked(View view) {
        ...
        tamilValues.put("FAVORITE", favorite.isChecked());
