...
public class RajasthanActivity extends AppCompatActivity {
    ...
    public void openhello() {
        Intent intent = new Intent(this,RajasthanMapActivity.class);
    ...
    public void onFavoriteClicked(View view) {
        ...
        rajasthanValues.put("FAVORITE", favorite.isChecked());
